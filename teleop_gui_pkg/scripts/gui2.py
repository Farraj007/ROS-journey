...
class TeleopSub(object):
    def __init__(self):
        ...
        self.create_subscription(Float32, "/wheel_angle_deg", self.wheelDegCallBack, 10)
        # rospy.Subscriber("/teleop_gui_pkg/wheel_angle_deg", stdmsg.Float32, self.wheelDegCallBack)
...
if __name__ == "__main__":
    import sys
    rclpy.init("plotter_", anonymous=True)
    # rospy.init_node("plotter_", anonymous=True)
    rclpy.loginfo("Teleop GUI started ... ")
    vehSub = TeleopSub()
